...
{
private:
    Bmp* img;                        // instancia de Bmp para acessar dados da imagem
    ...
    int countL[256];          // contador dos tons de cinza
    ...
    int* maxL;            // valor do tom de cinza com mais ocorrencia
...
public:
    int  isLuminance; // flag para ver se imagem esta em tons de cinza
    Histogram();
    ~Histogram();
